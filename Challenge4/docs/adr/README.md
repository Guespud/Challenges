...
| [009](ADR-009-sync-vs-async-communication.md) | Comunicación sync (HTTP) vs async (eventos) entre servicios | Aceptado |
| [010](ADR-010-distributed-transactions.md) | Estrategia de transacciones distribuidas (saga de pago) | Aceptado |
| [011](ADR-011-api-versioning.md) | Versionado de APIs | Aceptado |
