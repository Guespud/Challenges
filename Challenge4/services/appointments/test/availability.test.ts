...
// A diferencia del monolito, patientId/doctorId ya no son FK a un User real
// (User vive en el servicio Auth, otra base) — son UUIDs opacos. No hace
// falta crear filas de usuario para este test, solo generar los IDs.
