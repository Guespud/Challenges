...
const { dashboard: text, table: tableText } = content.habits;
...
export function PatientDashboardPage() {
  ...
  return (
    <div className="mx-auto flex max-w-2xl flex-col gap-6 px-4 py-8 sm:px-6">
      ...
      {history && (
        <section className="flex flex-col rounded-3xl border border-neutral-100 bg-white p-6 shadow-[0_20px_60px_-15px_rgba(0,0,0,0.15)] sm:p-8">
          <h2 className="mb-4 flex-none text-lg font-bold tracking-tight text-neutral-900">{tableText.title}</h2>
